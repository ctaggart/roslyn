...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    /// report) cycles.
    /// </summary>
    public sealed class ConstantFieldsInProgress
    {
        private readonly SourceFieldSymbol _fieldOpt;
        private readonly HashSet<SourceFieldSymbolWithSyntaxReference> _dependencies;

        public static readonly ConstantFieldsInProgress Empty = new ConstantFieldsInProgress(null, null);

        public ConstantFieldsInProgress(
        ...
        public void AddDependency(SourceFieldSymbolWithSyntaxReference field)
        {
