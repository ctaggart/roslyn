...
{
    public sealed class LambdaSymbol : MethodSymbol
    {
        ...
        public LambdaSymbol ToContainer(Symbol containingSymbol)
        {
        ...
        public void SetInferredReturnType(TypeSymbol inferredReturnType)
        {
