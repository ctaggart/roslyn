...
namespace Roslyn.Utilities
{
    ...
    /// only.
    /// </summary>
    public static class CorLightup
    {
        public static class Desktop
        {
            private static class _CultureInfo
            {
                public static readonly Type Type = typeof(CultureInfo);

                public static readonly PropertyInfo CultureTypes = Type
                    .GetTypeInfo()
            ...
            {
                public const int UserCustomCulture = 8;
            }

            public static bool? IsUserCustomCulture(CultureInfo cultureInfo)
            {
            ...
            {
                public static readonly Type TypeOpt = ReflectionUtilities.TryGetType("System.Runtime.InteropServices.RuntimeEnvironment, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");

                public static readonly Func<string> GetRuntimeDirectoryOpt = TypeOpt?
                    .GetTypeInfo()
                    .GetDeclaredMethod("GetRuntimeDirectory", SpecializedCollections.EmptyArray<Type>())?
                    .CreateDelegate<Func<string>>();
            }

            public static string TryGetRuntimeDirectory() => _RuntimeEnvironment.GetRuntimeDirectoryOpt?.Invoke();

            private static class _Assembly
            {
                public static readonly Type Type = typeof(Assembly);

                public static readonly Func<byte[], Assembly> Load_bytes = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("Load", typeof(byte[]))
                    .CreateDelegate<Func<byte[], Assembly>>();

                public static readonly Func<string, Assembly> LoadFile = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("LoadFile", typeof(string))
                    .CreateDelegate<Func<string, Assembly>>();

                public static readonly Func<Assembly, string> get_Location = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("get_Location")
                    .CreateDelegate<Func<Assembly, string>>();

                public static readonly Func<Assembly, bool> get_GlobalAssemblyCache = Type
                    .GetTypeInfo()
            ...
            {
                public static readonly Type Type = ReflectionUtilities.TryGetType("System.ResolveEventArgs");

                public static readonly MethodInfo get_Name = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("get_Name");

                public static readonly MethodInfo get_RequestingAssembly = Type
                    .GetTypeInfo()
            ...
            {
                public static readonly Type Type = ReflectionUtilities.TryGetType("System.AppDomain");
                public static readonly Type ResolveEventHandlerType = ReflectionUtilities.TryGetType("System.ResolveEventHandler");

                public static readonly MethodInfo get_CurrentDomain = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("get_CurrentDomain");

                public static readonly MethodInfo add_AssemblyResolve = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("add_AssemblyResolve", ResolveEventHandlerType);

                public static readonly MethodInfo remove_AssemblyResolve = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod("remove_AssemblyResolve", ResolveEventHandlerType);
            }

            public static Assembly LoadAssembly(byte[] peImage)
            {
            ...
            public static bool IsAssemblyFromGlobalAssemblyCache(Assembly assembly)
            {
            ...
            public static object GetCurrentAppDomain()
            {
            ...
            public static void GetOrRemoveAssemblyResolveHandler(Func<string, Assembly, Assembly> handler, MethodInfo handlerOperation)
            {
            ...
            public static void AddAssemblyResolveHandler(Func<string, Assembly, Assembly> handler)
            {
                GetOrRemoveAssemblyResolveHandler(handler, _AppDomain.add_AssemblyResolve);
            }

            public static void RemoveAssemblyResolveHandler(Func<string, Assembly, Assembly> handler)
            {
